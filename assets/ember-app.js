    ...
    modelClass.defineProjection('ТехКартыE', 'i-i-s-gladkov-kursovaya-тех-карты', {
      ...
      тчТехКарты: (0, _attributes.hasMany)('i-i-s-gladkov-kursovaya-тч-тех-карты', 'Тч тех карты', {
        ...
        чертежи: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-чертежи', 'Чертежи', {
          ...
          заявки: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-заявки', '', {
            материалы: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-материалы', '', {
              наименование: (0, _attributes.attr)('Материал', { index: 4 })
            }, { index: -1, hidden: true })
          }, { index: -1, hidden: true })
...
define('ember-app/mixins/regenerated/models/i-i-s-gladkov-kursovaya-\u0447\u0435\u0440\u0442\u0435\u0436\u0438', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ЧертежиE', 'i-i-s-gladkov-kursovaya-чертежи', {
      ...
      заявки: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-заявки', 'Заявки', {
        наименДетали: (0, _attributes.attr)('Деталь', { index: 3, hidden: true }),
        материалы: (0, _attributes.belongsTo)('i-i-s-gladkov-kursovaya-материалы', '', {
          наименование: (0, _attributes.attr)('Материал', { index: 4 })
        }, { index: -1, hidden: true })
